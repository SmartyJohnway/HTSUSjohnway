...
var build_search_index_exports = {};
__export(build_search_index_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(build_search_index_exports);
...
var handler = async () => {
  ...
  await store.setJSON("search/index.json", { updatedAt: (/* @__PURE__ */ new Date()).toISOString(), docs });
...
//# sourceMappingURL=build-search-index.js.map
